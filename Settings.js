function init() {
    ...
    var noFade = System.Gadget.Settings.read("noFade");
	if (noFade != "") {
		document.getElementById("noFade").checked = noFade;
    }
	...
	try {
			...
			if(numProcesses > 0)
      {
        ...
        return;
            ...
            System.Gadget.Settings.write("noFade", document.getElementById("noFade").checked);
